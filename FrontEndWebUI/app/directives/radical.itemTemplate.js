...
(function () {
    ...
    var module = angular.module('radical.itemTemplate', []);

    module.provider('radicalItemTemplateConfig', function radicalItemTemplateConfigProvider() {
    ...
    module.directive('radicalItemTemplate', ['$parse', '$compile', '$log', 'radicalItemTemplateConfig', itemTemplateDirective]);
